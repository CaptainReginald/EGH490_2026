...
MODEL_PATH = "cgras_segmentation/train_genera_model2/weights/best.pt"
YAML_PATH = "data/genera/cgras_data.yaml"
OUTPUT_PATH = "data/cgras_segmentation/train_genera_model2/validation_results"
CONF_THRESHOLD = 0.5
IOU_THRESHOLD = 0.5
